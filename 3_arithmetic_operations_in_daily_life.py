...
price_bread, price_peanut_butter, price_jelly = 4.99, 3.99, 2.79 #prices of our items
TAX_RATE = .0825 #tax rate of 8.25% in decimal form

subtotal = price_bread + price_peanut_butter + price_jelly
...
INTEREST_RATE = .07 #annual percent interest of 9.2% in decimal format
account_principle = 10000 #our account principle
